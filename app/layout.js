            ...
            <footer className="bg-black bg-gradient-to-b from-black via-gray-900 to-black py-12 md:py-6">
              <div className="container mx-auto px-4">
                <div className="flex flex-col items-center space-y-6">
                  ...
                  <a
                      href="mailto:milindbhushan007@gmail.com"
                      target="_blank"
                    ...
                    >
                      <svg
                        ...
                        viewBox="0 0 24 24"
                      >
                        <path d="M20 4H4C2.9 4 2 4.9 2 6v12c0 1.1.9 2 2 2h16c1.1 0 2-.9 2-2V6c0-1.1-.9-2-2-2zm-1.2 2L12 11.6 5.2 6h13.6zM4 18V8.5l8 5.3 8-5.3V18H4z" />
                      </svg>
                    </a>
